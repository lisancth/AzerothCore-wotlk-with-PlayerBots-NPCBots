...
-- Slack DPS Button
local followOnlyDpsButton = CreateFrame("Button", "NetherbotFollowOnlyDpsButton", frame, "ActionButtonTemplate")
followOnlyDpsButton:SetPoint("TOPLEFT", followOnlyButton, "BOTTOMLEFT", -117, -152)
followOnlyDpsButton:SetSize(42, 42)
local followOnlyDpsButtonText = followOnlyDpsButton:CreateFontString(nil, "OVERLAY")
followOnlyDpsButtonText:SetFont("Fonts\\FRIZQT__.TTF", 11, "OUTLINE")
followOnlyDpsButtonText:SetText("DPS \nSlack")
followOnlyDpsButtonText:SetPoint("CENTER", 0, 0)
followOnlyDpsButtonText:SetTextColor(1, 1, 0)

local followOnlyDpsTexture = followOnlyDpsButton:CreateTexture(nil, "BACKGROUND")
followOnlyDpsTexture:SetTexture("Interface\\Icons\\Spell_Shadow_SoulLeech")
followOnlyDpsTexture:SetAllPoints()
followOnlyDpsButton:SetNormalTexture(followOnlyDpsTexture)

local followOnlyDpsPushedTexture = followOnlyDpsButton:CreateTexture(nil, "BACKGROUND")
followOnlyDpsPushedTexture:SetTexture("Interface\\Icons\\Spell_Shadow_SoulLeech")
followOnlyDpsPushedTexture:SetAllPoints()
followOnlyDpsButton:SetPushedTexture(followOnlyDpsPushedTexture)

-- Slack Healers Button
local followOnlyHealersButton = CreateFrame("Button", "NetherbotFollowOnlyHealersButton", frame, "ActionButtonTemplate")
followOnlyHealersButton:SetPoint("LEFT", followOnlyDpsButton, "RIGHT", 5, 0)
followOnlyHealersButton:SetSize(42, 42)
local followOnlyHealersButtonText = followOnlyHealersButton:CreateFontString(nil, "OVERLAY")
followOnlyHealersButtonText:SetFont("Fonts\\FRIZQT__.TTF", 11, "OUTLINE")
followOnlyHealersButtonText:SetText("Heal \nSlack")
followOnlyHealersButtonText:SetPoint("CENTER", 0, 0)
followOnlyHealersButtonText:SetTextColor(1, 1, 0)

local followOnlyHealersTexture = followOnlyHealersButton:CreateTexture(nil, "BACKGROUND")
followOnlyHealersTexture:SetTexture("Interface\\Icons\\Spell_Holy_LayOnHands")
followOnlyHealersTexture:SetAllPoints()
followOnlyHealersButton:SetNormalTexture(followOnlyHealersTexture)

local followOnlyHealersPushedTexture = followOnlyHealersButton:CreateTexture(nil, "BACKGROUND")
followOnlyHealersPushedTexture:SetTexture("Interface\\Icons\\Spell_Holy_LayOnHands")
followOnlyHealersPushedTexture:SetAllPoints()
followOnlyHealersButton:SetPushedTexture(followOnlyHealersPushedTexture)

-- Slack Melee Button
local followOnlyMeleeButton = CreateFrame("Button", "NetherbotFollowOnlyMeleeButton", frame, "ActionButtonTemplate")
followOnlyMeleeButton:SetPoint("LEFT", followOnlyHealersButton, "RIGHT", 5, 0)
followOnlyMeleeButton:SetSize(42, 42)
local followOnlyMeleeButtonText = followOnlyMeleeButton:CreateFontString(nil, "OVERLAY")
followOnlyMeleeButtonText:SetFont("Fonts\\FRIZQT__.TTF", 11, "OUTLINE")
followOnlyMeleeButtonText:SetText("Melee \nSlack")
followOnlyMeleeButtonText:SetPoint("CENTER", 0, 0)
followOnlyMeleeButtonText:SetTextColor(1, 1, 0)

local followOnlyMeleeTexture = followOnlyMeleeButton:CreateTexture(nil, "BACKGROUND")
followOnlyMeleeTexture:SetTexture("Interface\\Icons\\Ability_Warrior_SavageBlow")
followOnlyMeleeTexture:SetAllPoints()
followOnlyMeleeButton:SetNormalTexture(followOnlyMeleeTexture)

local followOnlyMeleePushedTexture = followOnlyMeleeButton:CreateTexture(nil, "BACKGROUND")
followOnlyMeleePushedTexture:SetTexture("Interface\\Icons\\Ability_Warrior_SavageBlow")
followOnlyMeleePushedTexture:SetAllPoints()
followOnlyMeleeButton:SetPushedTexture(followOnlyMeleePushedTexture)
...
-- Summon Button
local SummonNPCButton = CreateFrame("Button", "NetherbotShow3Button", frame, "ActionButtonTemplate")
...
unbindButton:SetScript("OnClick", function()
    SendChatMessage(".npcbot command unbind", "GUILD")
end)
...
local attackDistanceShortButton = CreateFrame("Button", "NetherbotAttackDistanceShortButton", frame, "ActionButtonTemplate")
...
local attackDistanceMediumButton = CreateFrame("Button", "NetherbotAttackDistanceMediumButton", frame, "ActionButtonTemplate")
...
local attackDistanceLongButton = CreateFrame("Button", "NetherbotAttackDistanceLongButton", frame, "ActionButtonTemplate")
...
attackDistanceLongButton:SetNormalTexture(attackDistanceLongTexture)
local attackDistanceLongPushedTexture = attackDistanceLongButton:CreateTexture(nil, "BACKGROUND")
attackDistanceLongPushedTexture:SetTexture("Interface\\Icons\\Inv_misc_punchcards_red")
attackDistanceLongPushedTexture:SetAllPoints()
attackDistanceLongButton:SetPushedTexture(attackDistanceLongPushedTexture)

local adminButton = CreateFrame("Button", "NetherbotAdminButton", frame, "UIPanelButtonTemplate")
adminButton:SetSize(60, 20)
adminButton:SetPoint("BOTTOMRIGHT", frame, "BOTTOMRIGHT", -10, 5) -- position the button in the bottom right of the frame
...
raidButton:SetPoint("BOTTOMRIGHT", frame, "BOTTOMRIGHT", -120, 5) -- position the button in the bottom right of the frame
...
reviveButton:SetPoint("BOTTOMRIGHT", frame, "BOTTOMRIGHT", -70, 5) -- Position between RaidFrame and Admin
...
-- Add Spread Button
local spreadButton = CreateFrame("Button", "NetherbotSpreadButton", frame, "ActionButtonTemplate")
spreadButton:SetPoint("LEFT", followOnlyHealersButton, "RIGHT", -88, -47)
spreadButton:SetSize(42, 42)
local spreadButtonText = spreadButton:CreateFontString(nil, "OVERLAY")
spreadButtonText:SetFont("Fonts\\FRIZQT__.TTF", 11, "OUTLINE")
spreadButtonText:SetText("Spread")
spreadButtonText:SetPoint("CENTER", 0, 0)
spreadButtonText:SetTextColor(1, 1, 0)

local spreadTexture = spreadButton:CreateTexture(nil, "BACKGROUND")
spreadTexture:SetTexture("Interface\\Icons\\Spell_Nature_Slow")
...
spreadPushedTexture:SetTexture("Interface\\Icons\\Spell_Nature_Slow")
spreadPushedTexture:SetAllPoints()
spreadButton:SetPushedTexture(spreadPushedTexture)

-- Spread Button Function
spreadButton:SetScript("OnClick", function()
    SendChatMessage(".npcbot command spread", "GUILD")
end)

-- Add SpreadIO Button
local spreadioButton = CreateFrame("Button", "NetherbotSpreadioButton", frame, "ActionButtonTemplate")
spreadioButton:SetPoint("LEFT", spreadButton, "RIGHT", 5, 0)
spreadioButton:SetSize(42, 42)
local spreadioButtonText = spreadioButton:CreateFontString(nil, "OVERLAY")
spreadioButtonText:SetFont("Fonts\\FRIZQT__.TTF", 11, "OUTLINE")
spreadioButtonText:SetText("Spread2")
spreadioButtonText:SetPoint("CENTER", 0, 0)
spreadioButtonText:SetTextColor(1, 1, 0)

local spreadioTexture = spreadioButton:CreateTexture(nil, "BACKGROUND")
spreadioTexture:SetTexture("Interface\\Icons\\Spell_Holy_CircleOfRenewal")
spreadioTexture:SetAllPoints()
spreadioButton:SetNormalTexture(spreadioTexture)

local spreadioPushedTexture = spreadioButton:CreateTexture(nil, "BACKGROUND")
spreadioPushedTexture:SetTexture("Interface\\Icons\\Spell_Holy_CircleOfRenewal")
spreadioPushedTexture:SetAllPoints()
spreadioButton:SetPushedTexture(spreadioPushedTexture)

-- SpreadIO Button Function
spreadioButton:SetScript("OnClick", function()
    SendChatMessage(".npcbot command spreadio", "GUILD")
end)

-- Add Stack Button
local stackButton = CreateFrame("Button", "NetherbotStackButton", frame, "ActionButtonTemplate")
stackButton:SetPoint("LEFT", spreadioButton, "RIGHT", 5, 0)
stackButton:SetSize(42, 42)
local stackButtonText = stackButton:CreateFontString(nil, "OVERLAY")
stackButtonText:SetFont("Fonts\\FRIZQT__.TTF", 13, "OUTLINE")
stackButtonText:SetText("Stack")
stackButtonText:SetPoint("CENTER", 0, 0)
stackButtonText:SetTextColor(1, 1, 0)

local stackTexture = stackButton:CreateTexture(nil, "BACKGROUND")
stackTexture:SetTexture("Interface\\Icons\\Spell_Nature_StrengthOfEarthTotem02")
stackTexture:SetAllPoints()
stackButton:SetNormalTexture(stackTexture)

local stackPushedTexture = stackButton:CreateTexture(nil, "BACKGROUND")
stackPushedTexture:SetTexture("Interface\\Icons\\Spell_Nature_StrengthOfEarthTotem02")
stackPushedTexture:SetAllPoints()
stackButton:SetPushedTexture(stackPushedTexture)

-- Stack Button Function
stackButton:SetScript("OnClick", function()
    SendChatMessage(".npcbot command stack", "GUILD")
end)

-- Add Pull Button
local pullButton = CreateFrame("Button", "NetherbotpullButton", frame, "ActionButtonTemplate")
pullButton:SetPoint("LEFT", stackButton, "RIGHT", -89, -48)
pullButton:SetSize(42, 42)
local pullButtonText = pullButton:CreateFontString(nil, "OVERLAY")
pullButtonText:SetFont("Fonts\\FRIZQT__.TTF", 14, "OUTLINE")
pullButtonText:SetText("Pull")
pullButtonText:SetPoint("CENTER", 0, 0)
pullButtonText:SetTextColor(1, 1, 0)

local pullTexture = pullButton:CreateTexture(nil, "BACKGROUND")
pullTexture:SetTexture("Interface\\Icons\\Ability_Hunter_SniperShot")
pullTexture:SetAllPoints()
pullButton:SetNormalTexture(pullTexture)

local pullPushedTexture = pullButton:CreateTexture(nil, "BACKGROUND")
pullPushedTexture:SetTexture("Interface\\Icons\\Spell_Nature_StrengthOfEarthTotem02")
pullPushedTexture:SetAllPoints()
pullButton:SetPushedTexture(pullPushedTexture)

-- pull Button Function
pullButton:SetScript("OnClick", function()
    -- 1. Priority: If targeting a bot/player, use 'selected' keyword to avoid 'name not found' errors.
    if UnitIsPlayer("target") then
        SendChatMessage(".npcbot order pull selected", "GUILD")
    -- 2. Secondary: If focus is set to a bot/player, we still have to use their name, 
    -- but we'll try 'focus' if the server supports it, or fallback to the name.
    elseif UnitIsPlayer("focus") then
        SendChatMessage(".npcbot order pull " .. UnitName("focus"), "GUILD")
    -- 3. Fallback: Use the automated smart tank selection.
    else
        SendChatMessage(".npcbot order pull tank", "GUILD")
    end
end)
...
distance1Button:SetScript("OnClick", function()
    SendChatMessage(".npcbot distance 30", "GUILD")
end)

distance2Button:SetScript("OnClick", function()
    SendChatMessage(".npcbot distance 50", "GUILD")
end)

distance3Button:SetScript("OnClick", function()
    SendChatMessage(".npcbot distance 85", "GUILD")
end)

attackDistanceShortButton:SetScript("OnClick", function()
    SendChatMessage(".npcbot distance attack 10", "GUILD")
end)

attackDistanceMediumButton:SetScript("OnClick", function()
    SendChatMessage(".npcbot distance attack 25", "GUILD")
end)

attackDistanceLongButton:SetScript("OnClick", function()
    SendChatMessage(".npcbot distance attack 40", "GUILD")
end)

ShowNPCButton:SetScript("OnClick", function()
    SendChatMessage(".npcbot unhide", "GUILD")
end)
...
followOnlyButton:SetScript("OnClick", function()
    SendChatMessage(".npcbot command follow only", "GUILD")
end)

followOnlyDpsButton:SetScript("OnClick", function()
    SendChatMessage(".npcbot command follow only dps", "GUILD")
end)

followOnlyHealersButton:SetScript("OnClick", function()
    SendChatMessage(".npcbot command follow only healers", "GUILD")
end)

followOnlyMeleeButton:SetScript("OnClick", function()
    SendChatMessage(".npcbot command follow only melee", "GUILD")
end)
...
buttonRecall:SetScript("OnClick", function()
    SendChatMessage(".npcbot recall", "GUILD")
end)
